...
export default function MyModal({
  ...
  const [yearMonthDay, setYearMonthDay] = useState(curData.yearMonthDay);
  const [category, setCategory] = useState(curData.category);
  const [description, setDescription] = useState(curData.description);
  const [value, setValue] = useState(curData.value);
  ...
  const handleChangeDate = (e) => {
    setYearMonthDay(e.target.value);
  };
              ...
              <div style={style.flexRowRadio}>
                <label htmlFor="cadastrarDespesas">
                  <input
                    ...
                    value={curData.type}
                    defaultChecked={curData.type === "-" ? true : false}
                    disabled={disabled}
